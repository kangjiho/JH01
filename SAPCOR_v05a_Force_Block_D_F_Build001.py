...
def Force_Block_D_F (w,t,Core,K,L,Accel,POST=False,FO_DIR=FO_DIR):
  ...
  #endregion } END OF GET BLOCK PROP (K,L)
  #============================================================================
...
#      Fixedm = BT['Fixed']
      ...
      Hm = 0
      Mm = Im = 1
  pass #[deleted]      Fixedm = 'FixedToBase'
  #endregion } END OF GET BLOCK PROP OF (K,L-1)
  #============================================================================
  #region { Get current state of (K,L)
  ...
  #endregion } END OF GET CURRENT STATE OF (K,L)
  #============================================================================
  #region { Signs
  # (K,L-1)~(K,L)
  #       h1, d1, h2, d2, delta
  ...
  #endregion } END OF SPRING CONTRACTION
  #============================================================================
  ...
  #endregion } END OF FORCES AND MOMENTS
  #============================================================================
  ...
  if Core['ApplyForces']['Block_DF']==True:
    ...
    #endregion                END OF ASSEMBLE ACCEL
    #===========================================================================
  ...
  #endregion                END OF FRICTION FORCES
  ##############################################################################
